...
import { ArrowLeft, Trees, CheckCircle, ArrowRight } from 'lucide-react';

const TurfInstallation = () => {
  const features = [
    'Premium artificial turf products',
    ...
    <main className="pt-32 pb-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="w-16 h-16 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
                <Trees size={32} className="text-primary" />
              </div>
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-display font-bold mb-4">Ready for a Maintenance-Free Lawn?</h2>
          <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Save water, save time, and enjoy a perfect lawn every day of the year.
          </p>
...
export default TurfInstallation;
