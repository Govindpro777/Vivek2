...
import { ArrowLeft, Flame, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    <main className="pt-32 pb-20">
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-display font-bold mb-4">Ready to Create Your Outdoor Oasis?</h2>
          <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Build the ultimate outdoor entertaining space for your family.
          </p>
