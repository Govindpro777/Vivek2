...
import '@typeform/embed/build/css/widget.css'; // important for styling [web:22]
...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const { unmount } = createWidget(TYPEFORM_ID, {
      ...
      height: 600,
      opacity: 0, // adjust if you want fade effect [web:22]
    });
            ...
            <div className="bg-card rounded-2xl p-8 shadow-xl border border-border">
              ...
              <div className="mb-6">
                ...
                <p className="text-muted-foreground text-sm mt-4">
                  Or use the form below to submit directly on this site.
                </p>
              </div>
